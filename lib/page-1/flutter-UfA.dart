      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              // cardAcg (1:237)
              margin: EdgeInsets.fromLTRB(12*fem, 0*fem, 19*fem, 43*fem),
              width: double.infinity,
              height: 130*fem,
              decoration: BoxDecoration (
            ...
            Container(
              // card9Uc (1:234)
              margin: EdgeInsets.fromLTRB(16*fem, 0*fem, 15*fem, 49*fem),
              width: double.infinity,
              height: 130*fem,
              decoration: BoxDecoration (
                color: Color(0x66ffffff),
            ...
            Container(
              // cardkDW (1:240)
              margin: EdgeInsets.fromLTRB(12*fem, 0*fem, 19*fem, 49*fem),
              width: double.infinity,
              height: 130*fem,
              decoration: BoxDecoration (
                color: Color(0x66ffffff),
